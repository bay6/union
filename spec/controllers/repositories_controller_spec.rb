...
describe RepositoriesController do
  ...
  let(:valid_attributes) { { "avatar_url" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved repository as @repository" do
        ...
        post :create, {:repository => { "avatar_url" => "invalid value" }}, valid_session
        assigns(:repository).should be_a_new(Repository)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested repository" do
        ...
        Repository.any_instance.should_receive(:update_attributes).with({ "avatar_url" => "MyString" })
        put :update, {:id => repository.to_param, :repository => { "avatar_url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the repository as @repository" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Repository.any_instance.stub(:save).and_return(false)
        put :update, {:id => repository.to_param, :repository => { "avatar_url" => "invalid value" }}, valid_session
        assigns(:repository).should eq(repository)
      end
